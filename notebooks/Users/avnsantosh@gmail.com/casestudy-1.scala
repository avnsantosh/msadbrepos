...
// MAGIC %md
// MAGIC 
// MAGIC # Learning ADP Professionally
// MAGIC ## This is  my first program in scala
...
val configs = Map(
  ...
  "fs.azure.account.oauth2.client.id" -> "94cf61a0-1dc6-432c-93a1-c542e0483dec",
  "fs.azure.account.oauth2.client.secret" -> dbutils.secrets.get(scope = "training-scope", key = "appsecret"),
  "fs.azure.account.oauth2.client.endpoint" -> "https://login.microsoftonline.com/0ef3b95d-e0e3-45e5-88ec-0bd5f68c931b/oauth2/token")

// COMMAND ----------

dbutils.fs.mount(
  source = "abfss://data@avnstorageaccount.dfs.core.windows.net/",
  mountPoint = "/mnt/data",
...
object SentimentDetector extends Serializable {
    val accessKey = "b0a6e2c4f28d4cd48051092ca39599c6"
    val host = "https://avntextanalytics.cognitiveservices.azure.com/"
